  ...
  return (
    ...
    <hr className="missionDivider" />
      ...
      <p className="italicText">
        This archive uses the word 'women' intentionally. It encompasses cisgender women, transgender women, and non-binary and gender non-conforming individuals. We recognize that the language of gender is evolving, that historical records are imperfect, and individuals documented here may not have used these terms to describe themselves. We have chosen inclusion because the alternative is to reproduce the very erasure this archive exists to resist.
      </p>
